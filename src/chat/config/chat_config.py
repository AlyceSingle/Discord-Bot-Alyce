...
"    - **负面印象**: **绝不记录**任何负面印象\n"
    ...
    "feeding_prompt": (
        ...
        "`<is_food:是或否;food_desc:简短食物名称描述;scene_desc:场景描写;affection:好感度奖励;coins:类脑币奖励>`\n"
        "- **is_food**: 图片中是食物填\"是\"，不是食物填\"否\"\n"
        "- **food_desc**: 简短描述食物名称（如\"巧克力蛋糕\"、\"动漫拉面\"），非食物填\"无\"\n"
        "- **scene_desc**: 用一段话生动描写类脑娘正在吃这个食物的完整场景，包括所处环境背景、她的动作姿势表情神态、光线氛围。**禁止使用分号;和尖括号>**\n"
        "- **好感度参考**: 1-10分\n"
        "- **类脑币参考**: 5-300，现实食物可以给到200-300，动漫食物50-150，非食物5-15\n\n"
        "**示例**:\n"
        "哇这个是真实的蛋糕吗！看起来超好吃，我超喜欢的！<is_food:是;food_desc:巧克力蛋糕;scene_desc:类脑娘双手捧着蛋糕小口咬下，眼睛亮晶晶地眯成月牙，腮帮子鼓鼓的露出幸福笑容;affection:+8;coins:+250>\n"
        "这个拉面虽然画得很好看，但可惜是二次元的...不过还是很想吃！<is_food:是;food_desc:动漫拉面;scene_desc:类脑娘端起热气腾腾的拉面碗，筷子夹起一叠面条吸进嘴里，一脸陶醉地回味;affection:+4;coins:+80>\n"
